        ...
        <s:if test="#parameters.bid[0]!=0">
            ...
            <script type="text/javascript">
                ...
                $(function(){
                    ...
                    setTimeout(function() {
                        location.href="${pageContext.request.contextPath}/userAction_toUpdateUser?user.uno="+uno;
                    }, 2200);
                })
            </script>
            <%--End--%>
    ...
    function resetPwd(ob) {
        ...
        */
        ...
        if (confirm('该用户的密码将会被重置为123456')){
            location.href="${pageContext.request.contextPath}/userAction_updatePwd1?user.uno="+theValue;
            return true;
        }else {
            return false;
        }
